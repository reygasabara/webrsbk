...
<body class="font-merriweather antialiased pt-[63px] lg:pt-[88px] text-slate-900 bg-slate-200 min-h-screen">
    <div id="outerContainer" class="">
        ...
        <footer id="footer" class="relative bg-slate-900 right-0 left-0">
