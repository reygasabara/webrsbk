...
@section('container')
    ...
    <section class="mt-32 mb-10 relative py-5">
        ...
        <div class="relative mt-5 mb-12 flex justify-center items-center" data-aos="fade-right">
        ...
        <div class="relative px-5 flex justify-between">
            <iframe
                ...
                class="w-[65%] h-[400px] rounded-xl"></iframe>

            <div class="w-[30%] h-[400px] rounded-xl bg-slate-100 p-3">
                <div class="overflow-hidden rounded-md">
                    ...
                    <div class="mt-5 flex items-center">
                        ...
                        <p class="text-sm text-justify">Jl. Gn. Meluhu No.7, Kec, Kec. Mandonga, Kota Kendari, Sulawesi
                            Tenggara 93117
                        </p>
                    </div>
    ...
    <section class="mt-32 mb-10">
        ...
        <div class="flex justify-around px-5">
            <div class="group w-[25%] rounded-md rounded-tl-[30px] rounded-br-[30px] shadow-md overflow-hidden hover:-translate-y-3 duration-500 bg-slate-100 p-3"
                ...
                <h3 class="font-bold text-center mt-3 text-2xl text-slate-900">Judul</h3>
                <p class="text-justify py-3 text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo
                    itaque
                    excepturi
                    accusamus eum, ipsam
                    eos expedita</p>
                <button
                    class="group/button relative rounded-lg bg-gradient-to-r from-yellow-400 to-yellow-400  active:from-yellow-500 active:to-green-600 duration-300 transition-colors px-3.5 text-xs capitalize text-white shadow shadow-black/60 mb-4 overflow-hidden w-24 h-8 flex items-center justify-center">
                    <a href="/"
