...
@section('container')
    <section class="mx-6 py-12">
        <h1 class="animate__animated animate__lightSpeedInLeft mb-2 inline-block text-2xl font-bold md:text-4xl">Poli Saraf
        </h1>
    ...
    <section class="mx-6 mb-20 mt-32 md:mb-12">
        ...
        <div class="flex flex-wrap justify-around md:-translate-x-1 lg:-translate-x-5">
            <div class="relative">
                <img src="{{ asset('img/happy.png') }}" alt="dokter saraf" class="relative z-10 w-40 lg:w-60"
                    loading="lazy">
            ...
            <div class="relative mt-20 md:ml-10 md:mt-0 lg:ml-0">
                <img src="{{ asset('img/ashaeryanto.png') }}" alt="dokter saraf" class="relative z-10 w-40 lg:w-60"
                    loading="lazy">
