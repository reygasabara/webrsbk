...
@section('container')
    <section class="mx-6 py-12">
        <h1 class="animate__animated animate__lightSpeedInLeft mb-2 inline-block text-2xl font-bold md:text-4xl">Poli Mata
        </h1>
    ...
    <section class="mx-6 mb-12 justify-between md:mx-12 md:flex">
        ...
        <div class="flex justify-center">
            <div class="relative mt-32 md:mt-0">
                ...
                <div
                    class="relative -top-16 z-20 w-[280px] rounded-md bg-yellow-300 py-1 pl-4 text-sm font-bold text-slate-900 shadow-md shadow-black/60 md:-top-8 md:w-60 md:pl-3 md:text-xs lg:-top-16 lg:w-72 lg:py-2 lg:pl-4 lg:text-sm">
                ...
                <div class="absolute bottom-16 left-6 h-64 w-20 bg-slate-200 md:left-0 md:hidden lg:left-12"></div>
            </div>
        </div>
    </section>
@endsection
