...
@section('container')
    ...
    <section class="mx-6 mb-20 md:mb-12 mt-32">
        ...
        <div class="flex flex-wrap justify-around md:-translate-x-1 lg:-translate-x-5">
            <div class="relative">
                <img src="{{ asset('img/neneng.png') }}" alt="dokter gigi" class="w-40 lg:w-60 z-10 relative">

                <div
                    class="bg-yellow-300 text-slate-900 font-bold rounded-md shadow-md shadow-black/60 w-64 lg:w-72 pl-4 py-2 relative z-20">
            ...
            <div class="relative mt-20 md:ml-10 lg:ml-0 md:mt-0">
                <img src="{{ asset('img/yunita.png') }}" alt="dokter gigi" class="w-40 lg:w-60 z-10 relative">
            ...
            <div class="relative mt-20 md:ml-10 lg:ml-0 lg:mt-0">
                <img src="{{ asset('img/nurul.png') }}" alt="dokter gigi" class="w-40 lg:w-60 z-10 relative">
