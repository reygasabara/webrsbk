...
@section('container')
    ...
    <section class="flex flex-wrap justify-evenly mb-12">
        <div
            class="group rounded-full hover:rounded-md hover:rounded-tl-[50px] hover:rounded-br-[50px] shadow-md w-[20%] p-5 bg-white text-center hover:scale-105 duration-200 overflow-hidden animate__animated animate__zoomIn mx-10 mb-16">
        ...
        <div
            class="group rounded-full hover:rounded-md hover:rounded-tl-[50px] hover:rounded-br-[50px] shadow-md w-[20%] p-5 bg-white text-center hover:scale-105 duration-200 overflow-hidden animate__animated animate__zoomIn animate__delay-1s mx-10 mb-16">
            <div class="translate-y-5 group-hover:translate-y-0 duration-200">
        ...
        <div
            class="group rounded-full hover:rounded-md hover:rounded-tl-[50px] hover:rounded-br-[50px] shadow-md w-[20%] p-5 bg-white text-center hover:scale-105 duration-200 overflow-hidden animate__animated animate__zoomIn animate__delay-2s mx-10 mb-16">
            <div class="translate-y-5 group-hover:translate-y-0 duration-200">
