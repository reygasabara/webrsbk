...
@section('container')
    <section class="py-12 mx-6 ">
        <h1 class="text-2xl md:text-4xl font-bold mb-2 animate__animated animate__lightSpeedInLeft inline-block">Poli Bedah
            Umum
        </h1>
    ...
    <section class="flex justify-between ml-12 mr-6 mb-12">
        <div class="w-[45%]">
            <p>Poli bedah umum adalah layanan kesehatan yang mengani pengobatan penyakit dan luka.</p>
