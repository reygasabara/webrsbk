...
@section('container')
    <section class="py-12 mx-6 ">
        <h1 class="text-2xl md:text-4xl font-bold mb-2 animate__animated animate__lightSpeedInLeft inline-block">Poli Obgyn
        </h1>
    ...
    <section class="mx-6 mb-20 md:mb-12 mt-32">
        ...
        <div class="flex flex-wrap justify-around md:-translate-x-1 lg:-translate-x-5">
            <div class="relative">
                <img src="{{ asset('img/putu.png') }}" alt="dokter obgyn" class="w-40 lg:w-60 z-10 relative">
            ...
            <div class="relative mt-20 md:ml-10 lg:ml-0 md:mt-0">
                <img src="{{ asset('img/suhartini.png') }}" alt="dokter saraf" class="w-40 lg:w-60 z-10 relative">
