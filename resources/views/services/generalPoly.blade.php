...
@section('container')
    <section class="py-12 mx-6 ">
        <h1 class="text-2xl md:text-4xl font-bold mb-2 animate__animated animate__lightSpeedInLeft inline-block">Poli Umum
        </h1>
    ...
    <section class="mx-6 md:mx-12 mb-24">
        <div class="">
            <p class="text-justify">Poli umum adalah salah satu jenis layanan yang memberikan pemeriksaan kesehaatan dan
                pengobatan secara umum.</p>

            <div class="relative bg-green-300/30 px-5 mt-16 py-5 w-[90%] md:w-[95%]">
                <p class="relative z-40 font-bold">Pelayanan unggulan poli umum</p>
