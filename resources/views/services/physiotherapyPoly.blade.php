...
@section('container')
    ...
    <section class="md:flex justify-between mx-6 md:mx-12 mb-24">
        <div class="">
            <p class="text-justify">Poli fisioterapi adalah layanan penanganan atau terapi untuk mengembalikan
                gerakan dan fungsi ketika seseorg
                mengalami cedera, terkena penyakit atau mengalami disabilitas.</p>
